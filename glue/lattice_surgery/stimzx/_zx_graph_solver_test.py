...
def test_disconnected():
    ...
    """
        ...
        == [
            ExternalStabilizer(
                input=stim.PauliString("Z"), output=stim.PauliString("_")
            ),
            ExternalStabilizer(
                input=stim.PauliString("_"), output=stim.PauliString("Z")
            ),
        ]
    )
    assert (
    ...
    """
        ...
        == [
            ExternalStabilizer(
                input=stim.PauliString("X"), output=stim.PauliString("_")
            ),
            ExternalStabilizer(
                input=stim.PauliString("_"), output=stim.PauliString("Z")
            ),
