...
def test_worker_stop():
    ...
    _put_wait_not_empty(
        ...
        (
            "change_job",
            (t0, sinter.CollectionOptions(max_errors=100_000_000), 100_000_000),
        ),
    )
...
def test_worker_finish_work():
    ...
    _put_wait_not_empty(
        ...
        (
            "change_job",
            (ta, sinter.CollectionOptions(max_errors=100_000_000), 100_000_000),
        ),
    )
    ...
    _assert_drain_queue(
        ...
        [
            (
                ...
                (
                    ta.strong_id(),
                    sinter.AnonTaskStats(shots=1000, errors=23, discards=0, seconds=1),
                ),
            )
        ],
    )
