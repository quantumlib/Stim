...
def test_add():
    ...
    assert a0 + b0 == sinter.AnonTaskStats(
        shots=270, errors=34, discards=43, seconds=52
    )
    ...
    assert a + b == sinter.AnonTaskStats(
        shots=270,
        errors=34,
        discards=43,
        seconds=52,
    ...
    assert a + b0 == sinter.AnonTaskStats(
        shots=270,
        errors=34,
        discards=43,
        seconds=52,
    ...
    assert a0 + b == sinter.AnonTaskStats(
        shots=270,
        errors=34,
        discards=43,
        seconds=52,
