...
const char * Z_BLUE = "#4DA6FF";
const char * X_RED = "#FF4040";
const char * Y_GREEN = "#59FF7A";
const char * EZ_ORANGE = "#FF9500";
const char * EX_PURPLE = "#FF4DDB";
const char * EY_YELLOW = "#F1FF59";
