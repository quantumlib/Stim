...
void LatticeMap::set(uint64_t index, stim::ConstPointerRange<uint64_t> offsets_per_iteration, stim::ConstPointerRange<uint64_t> iteration_counts, uint32_t value) {
