...
//
//#include "stim/diagram/timeline/timeline_svg.h"
//
...
//
//TEST(circuit_diagram_timeline_svg, XXXXXXXXXXX) {
//    ASSERT_TRUE(false);
//}
//
//TEST(circuit_diagram_timeline_svg, repeat2XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX) {
...
//    fprintf(f, "%s", tx.data());
//    fclose(f);
//    std::cerr << circuit_diagram_timeline_svg(circuit);
//}
