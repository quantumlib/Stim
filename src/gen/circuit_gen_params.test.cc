...
TEST(circuit_gen_params, append_begin_round_tick) {
    ...
    ASSERT_EQ(circuit, Circuit::from_text("TICK"));
...
TEST(circuit_gen_params, append_unitary_1) {
    ...
    ASSERT_EQ(circuit, Circuit::from_text("H 2 3 5"));
...
TEST(circuit_gen_params, append_unitary_2) {
    ...
    ASSERT_EQ(circuit, Circuit::from_text("CX 2 3 5 7"));
...
TEST(circuit_gen_params, append_measure) {
    ...
    ASSERT_EQ(circuit, Circuit::from_text("M 2 3 5\nM 2 3 5"));
...
TEST(circuit_gen_params, append_measure_reset) {
    ...
    ASSERT_EQ(circuit, Circuit::from_text("MR 2 3 5\nMR 2 3 5"));
    ...
    params.append_measure_reset(circuit, {1}, 'X');
    params.append_measure_reset(circuit, {4}, 'Y');
    ASSERT_EQ(circuit, Circuit::from_text(R"CIRCUIT(
        X_ERROR(0.125) 2 3 5
        MR 2 3 5
        X_ERROR(0.25) 2 3 5
        Z_ERROR(0.125) 1
